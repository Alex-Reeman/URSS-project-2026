...
#H=0.1 
#mag_mfc = np.array([0.17502, 0.190435, 0.219833, 0.302977, 0.0755972, 0.0531804, 0.0432086,0.0490726,0.0389644,0.0586824])
...
plt.tight_layout()
plt.savefig("magvtemp_h=0.08.png", dpi=300)
plt.show()